...
export const resultData: ResultData = {
  stress: {
    ...
    drinkExplain2:
      "ミャンマーラペイエは、忙しい日常の中でリラックスするための素晴らしい選択です。紅茶の深い香りと爽やかな味わいは、心を落ち着かせる効果があります。また、シナモンは温かみのあるスパイスで、リラックス効果とともに、血行を促進し体を温める効果も期待できます。そして、コンデンスミルクのまろやかで甘い風味が加わることで、心地よい甘さがストレスを軽減し、心身ともにリラックスさせてくれます。このドリンクを楽しむひとときは、まさに至福のリラクゼーションタイムとなるでしょう。",
  },
  tired: {
    bugName: "疲労",
    ...
    drinkExplain2:
      "梅干しティーサワーは、疲労回復に効果的な一杯です。レモンティーに含まれるビタミンCは、抗酸化作用があり、免疫力を高める効果があります。また、レモンの爽やかな酸味は、疲れた体をリフレッシュさせてくれます。梅干しはクエン酸が豊富で、エネルギー代謝を促進し、疲労物質の分解を助けます。さらに、炭酸水のシュワシュワとした刺激が、飲むたびに気分をリフレッシュさせ、爽快感をもたらします。このドリンクは、運動後や仕事の合間に飲むことで、疲れを癒し、体と心に活力を取り戻すのに最適です。",
  },
  depression: {
    bugName: "鬱屈",
    ...
    drinkExplain2:
      "チョコミルクティーは、鬱屈した気分を和らげる効果があります。ココアに含まれるテオブロミンとフェニルエチルアミンは、脳内の幸せホルモンであるセロトニンの分泌を促進し、気分を高める効果があります。ミルクティーは、紅茶のリラックス効果とミルクの優しい風味が心を穏やかにしてくれます。さらに、コンデンスミルクの濃厚な甘さが加わることで、心地よい甘さが心の緊張をほぐし、心地よい満足感を与えてくれます。このドリンクは、ストレスがたまったときや気分が落ち込んでいるときにぴったりで、心を温かく包み込み、穏やかなひとときを提供してくれます。",
  },
  playful: {
    bugName: "遊びすぎ",
    ...
    drinkExplain2:
      "イタリアンジューシーは、童心に帰らせる効果があります。午後の紅茶レモンティーの爽やかな香りと味わいは、どこか懐かしい夏の日の記憶を呼び覚まします。オレンジジュースのフルーティーな甘さと酸味が、活気に満ちた子供時代の元気な気持ちを蘇らせます。そして、みかんの優しい甘さとジューシーな食感が、童心の無邪気さと純真さを思い出させてくれます。最後に、シロップのほんのりとした甘さが全体を包み込み、一口飲むたびに心が温かく満たされる感覚をもたらします。このドリンクは、大人になって忙しい日々を過ごす中で、ふとした瞬間に童心に帰り、心をリフレッシュさせるのにぴったりです。",
  },
  healthy: {
    bugName: "健康そのもの",
    ...
    drinkExplain1:
      "午後の紅茶おいしい無糖、炭酸水、オレンジジュース、みかん、シロップ",
    drinkExplain2:
      "スパークリングオレンジティーは、健康を増進するのに最適な一杯です。ストレートティーは、カフェインによる適度な覚醒効果と豊富な抗酸化物質が特徴で、体のバランスを整えてくれます。炭酸水が加わることで、爽快感が増し、リフレッシュ効果が期待できます。オレンジジュースはビタミンCを豊富に含み、免疫力を強化し、疲労回復を助けます。みかんの自然な甘さと栄養素が、フルーツのフレッシュさを引き立て、健康的なエネルギー補給をサポートします。このドリンクは、体に良い成分をバランスよく含んでおり、日々の健康維持にぴったりです。健康志向の方におすすめの、リフレッシュしながら栄養を補給できる完璧なドリンクです。",
  },
};
