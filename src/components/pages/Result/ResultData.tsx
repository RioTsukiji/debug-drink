...
export const menuAll: { name: string; price: number; content: string }[] = [
  {
    name: "スパークリングオレンジティー",
    price: 250,
    content: "紅茶（無糖）、みかん、オレンジジュース、炭酸水",
  },
  {
    name: "イタリアンジューシー",
    price: 200,
    content: "紅茶（レモンティー）、みかん、オレンジジュース",
  },
  {
    name: "ミャンマーラペイエ",
    price: 250,
    content: "紅茶（ストレートティー）、シナモンパウダー、コンデンスミルク",
  },
  {
    name: "チョコミルクティー",
    price: 200,
    content: "紅茶（ミルクティー）、ココア、コンデンスミルク",
  },
  {
    name: "梅干しティーサワー",
    price: 200,
    content: "紅茶（レモンティー）、梅干し、炭酸水",
  },
];
